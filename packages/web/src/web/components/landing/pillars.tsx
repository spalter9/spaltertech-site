...
import { ShieldCheck, AudioWaveform, Link2, ArrowRight, type LucideIcon } from "lucide-react";
 ...
 * underlying tech pillars (Master Trust, Surrealizer, SSP). Each links into
...
const PILLARS: Pillar[] = [
  {
    ...
    maps: "Powered by the Master Trust",
    slug: "master-trust",
          ...
          {PILLARS.map((p, i) => (
            ...
            >
              ...
              >
                ...
                <p className="text-muted text-sm leading-relaxed mt-4 flex-1">{p.body}</p>
